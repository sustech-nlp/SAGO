...
from trainer.unlearn.npo_forget import NPOForget
from trainer.unlearn.simnpo import SimNPO
from trainer.unlearn.simnpo_forget import SimNPOForget
from trainer.unlearn.rmu import RMU
from trainer.unlearn.grad_surgery import GradDiffWithSurgery, NPOWithSurgery, SimNPOWithSurgery
...
_register_trainer(NPOForget)
_register_trainer(SimNPO)
_register_trainer(SimNPOForget)
_register_trainer(RMU)
_register_trainer(GradDiffWithSurgery)
_register_trainer(NPOWithSurgery)
_register_trainer(SimNPOWithSurgery)
